...
<title>Delete Student Subject - ACE Tutor</title>
...
<div class="sidenav">
	...
	<a href="ClassAssign.php"><i class="fas fa-chalkboard-teacher"></i>Class 
		Assignation</a>
...
<div>
		...
		$jid = $_GET['id'];
		$result = mysqli_query($con, "DELETE FROM subject WHERE jid ='$jid'");
		
		if (!$result){
		echo "<script type=\"text/javascript\">";
		echo "Swal.fire({";
		echo "title: 'Subject is not deleted!',";
		...
		echo "<script type=\"text/javascript\">";
		echo "Swal.fire({";
		echo "title: 'Subject is deleted successfully!',";
	    echo "icon: 'success'}).";
	    echo "then((result) => {";
	  	echo "if (result.isConfirmed) {";
		echo "window.location.href='Subject.php';}})";
