...
<title>Update Class Details - ACE Tutor</title>
...
<div class="main">
		...
		$sql1= "UPDATE class SET date='$date', time='$time', venue='$venue', fid='$fid', jid='$jid' WHERE cid='$cid';";
		
		if (!mysqli_query($con, $sql1)){
		echo "<script type=\"text/javascript\">";
		echo "Swal.fire({";
		echo "title: 'Class is not updated!',";
		...
		echo "<script type=\"text/javascript\">";
		echo "Swal.fire({";
		echo "title: 'Class is updated successfully!',";
	    echo "icon: 'success'}).";
	    echo "then((result) => {";
	  	echo "if (result.isConfirmed) {";
		echo "window.location.href='ClassAssign.php';}})";
