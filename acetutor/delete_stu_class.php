...
<title>Delete Student from Class - ACE Tutor</title>
...
<div>
		...
		$result = mysqli_query($con, "DELETE FROM student_class WHERE cid='$cid' AND sid='$sid';");
		
		if (!$result){
		echo "<script type=\"text/javascript\">";
		echo "Swal.fire({";
		echo "title: 'Student is not deleted from class!',";
