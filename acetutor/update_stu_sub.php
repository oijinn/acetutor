...
<title>Student Subject - ACE Tutor</title>
...
<div class="main">
		...
		$sql1 = "INSERT INTO student_subject (sid, jid) VALUES('$sid', '$jid');";
		
		if (!mysqli_query($con, $sql1)){
		echo "<script type=\"text/javascript\">";
		echo "Swal.fire({";
		echo "title: 'Invalid Subject ID!',";
	    echo "icon: 'error'}).";
	    echo "then((result) => {";
	  	echo "if (result.isConfirmed) {";
		echo "window.location.href='add_stu_sub.php';}})";
		echo "</script>";	
		}	
		else{
		echo "<script type=\"text/javascript\">";
